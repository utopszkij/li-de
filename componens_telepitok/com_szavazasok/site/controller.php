...
class SzavazasokController extends JControllerLegacy {
  ...
  public function save()	{
	...
	//+ 2016.03.04 biztos ami biztos
	if (JRequest::getVar('temakor') <= 0) JRequest::setVar('temakor',20);
	if (JRequest::getVar('temakor_id') <= 0) JRequest::setVar('temakor_id',20);
	//DBG echo 'POST:'.JSON_encode($_POST).'<br>GET:'.JSON_encode($_GET); 
	//+ 2016.03.04 biztos ami biztos
  ...
  public function szavazoform() {
    ...
    $item = $this->model->getItem(JRequest::getVar('szavazas'));
    if (($item->szavazas == 1) &
        (($item->szavazok == 1) | ($item->szavazok == 0) |
