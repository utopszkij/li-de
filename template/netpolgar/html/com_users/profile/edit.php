...
if ($user->params->avatar == '') $user->params->avatar = 'http://gravatar.com/avatar/'.md5(strtolower(trim($user->email))).'?s='.$w.'mmg';
...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
	...
	<div class="control-group">
		...
		<div class="controls">
		   <input type="text" name="avatar" value="<?php echo $user->params->avatar; ?>" style="width:500px" />
		</div>			
	</div>
