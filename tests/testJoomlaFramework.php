...
*
* set JRequest input:    $this->inputs['nsme'] = 'xxxx';
* set dbResult:          $dbResults[] = JSON_decode('json_string');
*/
error_reporting(E_ALL & ~E_NOTICE);
define( '_JEXEC', 1 );
define( 'DS', DIRECTORY_SEPARATOR );
define('JPATH_BASE', 'componens_telepitok');
define('JPATH_ROOT', 'componens_telepitok');
define('JPATH_ADMINISTRATOR', 'componens_telepitok/admin');
define('_UNITTEST', '1');
...
class JTable {
	...
	public static function addIncludePath($s) {
